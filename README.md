...
<p align="left">I turn coffee into code, bugs into features, and wild ideas into full-stack chaos. LLMs, Web3, and anything the internet dares me to tackle—breaking stuff, building smarter, and having way too much fun along the way.</p>
...
<div align="left">
  <!-- TypeScript -->
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg" alt="TypeScript" style="height:40px; margin-right:12px;" />

<!-- React -->
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" alt="React" style="height:40px; margin-right:12px; background:#fff; border-radius:5px; padding:2px;" />

<!-- Jest -->
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jest/jest-plain.svg" alt="Jest" style="height:40px; margin-right:12px;" />

<!-- Web3.js -->
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/web3js/web3js-plain.svg" alt="Web3.js" style="height:40px; margin-right:12px;" />

<!-- Netlify -->
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/netlify/netlify-original.svg" alt="Netlify" style="height:40px; margin-right:12px;" />
...
<!-- PostgreSQL -->
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg" alt="PostgreSQL" style="height:40px; margin-right:12px; background:#fff; border-radius:5px; padding:2px;" />
...
<!-- LLaMA -->
<img src="https://raw.githubusercontent.com/facebookresearch/llama/main/llama_logo.svg" alt="LLaMA" style="height:40px; margin-right:12px; background:#fff; padding:4px; border-radius:5px;" />

<!-- Pinecone -->
<img src="https://avatars.githubusercontent.com/u/54333248?s=200&v=4" alt="Pinecone" style="height:40px; margin-right:12px; border-radius:5px;" />

<!-- Jenkins -->
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jenkins/jenkins-original.svg" alt="Jenkins" style="height:40px; margin-right:12px;" />

<!-- Docker -->
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg" alt="Docker" style="height:40px; margin-right:12px;" />

<!-- AWS -->
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/amazonwebservices/amazonwebservices-original-wordmark.svg" alt="AWS" style="height:40px; margin-right:12px; background:#fff; padding:4px; border-radius:5px;" />
